            ...
            <Container fluid style={{ padding: "0px 64px" }}>
                <Row className={styles.contantLine} ref={componentRef}>
                    ...
                    <Col className={styles.OurPartner} sm={3}>
                        <img style={{ height: (width > 922) ? "300px" : "200px" }} src="/assets/partner/Plantoys.svg" alt="" /></Col>
                    <Col className={styles.OurPartner} sm={3}>
                        <img style={{ height: (width > 922) ? "300px" : "200px" }} src="/assets/partner/Berg.svg" alt="" /></Col>
                    <Col className={styles.OurPartner} sm={3}>
                        <img style={{ height: (width > 922) ? "300px" : "200px" }} src="/assets/partner/Thaifight.svg" alt="" /></Col>
                </Row>
            </Container>
